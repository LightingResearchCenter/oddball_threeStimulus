function [timeFreqEpochs, timeFreq_target, timeFreq_distr, timeFreq_std, derivedMeasures_target, derivedMeasures_distr, derivedMeasures_std] = ...
    ...
    % TARGET
    [timeFreqEpochs.target.real, timeFreqEpochs.target.imag, derivedMeasures_target, timeFreq_target] = ...
        analyze_timeFreqAnalysisForCondition(epochs_raw, artifactIndices_FASTER, 'target', IAF, parameters, handles);   
    
    % DISTRACTER
    [timeFreqEpochs.distr.real, timeFreqEpochs.distr.imag, derivedMeasures_distr, timeFreq_distr] = ...
        analyze_timeFreqAnalysisForCondition(epochs_distr_raw, artifactIndices_FASTER_distr, 'distracter', IAF, parameters, handles);
    
    % STANDARD
    [timeFreqEpochs.std.real, timeFreqEpochs.std.imag, derivedMeasures_std, timeFreq_std] = ...
