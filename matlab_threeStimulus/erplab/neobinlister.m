...
function [EEG EVENTLIST binOfBins isparsenum] = neobinlister(EEG, bdfilename, eventlist, neweventlist, forbiddenCodeArray, ignoreCodeArray, reportable)
