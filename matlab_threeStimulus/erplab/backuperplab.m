% Backup current ERPLAB folder at EEGLAB's plugins folder
%
%
...
try
    cleanerplab
    fname    = [bckupname '.zip'];
    fullname = fullfile(pluginspath, fname); % save the zip file at plugins folder
    zip(fullname, cvname, pluginspath);
    fprintf('Your current ERPLAB was bucked up in %s\n', fullname);
catch
