% setcodebit (alpha version)
% 
% EEG = setcodebit(EEG,bitindex) sets the bit(s) at position(s) "bitindex" in each EEG.event(i).type value to 0 (off).
...
% Example:
% 
% In the Biosemi system you have a 16-bit word for sending your event codes. However, you generally only use event codes from 1 to 255
