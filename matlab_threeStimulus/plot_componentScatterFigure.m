% SCATTER
function plot_componentScatterFigure(fig, statsOut, matricesSessionNorm, noOfSessions, normalizationTypes, erpComponent, erpFilterType, chsToPlot, chSelected, erpTypes, fieldValue, subjects, handles)
