function [rejectedEpochs_target, rejectedEpochs_distr, rejectedEpochs_std, artifactIndices_FASTER_target, artifactIndices_FASTER_distr, artifactIndices_FASTER_std] = ...
    ...
    disp('      .. Find artifacts (Fixed EEG/EOG, CRAP: Moving Average & Step)')    
        ...
        % TARGET
        fprintf('         .. TARGET / ')
        [NaN_indices_EEG_target, NaN_indices_EOG_target, NaN_indices_moving_target, NaN_indices_step_target, vDiffOutMovWindow_target, vDiffOutStep_target, fixedIndices_target] = ...
        ...
        if debugOnlyTarget ~= 1
            ...
            % DISTRACTER
            fprintf('DISTRACTER / ')
            [NaN_indices_EEG_distr, NaN_indices_EOG_distr, NaN_indices_moving_distr, NaN_indices_step_distr, vDiffOutMovWindow_distr, vDiffOutStep_distr, fixedIndices_distr] = ...
            ...
            [NaN_indices_EEG_std, NaN_indices_EOG_std, NaN_indices_moving_std, NaN_indices_step_std, vDiffOutMovWindow_std, vDiffOutStep_std, fixedIndices_std] = ...
    ...
    if debugOnlyTarget ~= 1
        [epochs_concan_FASTER_distr, artifactIndices_FASTER_distr] = pre_artifactFASTER_wrapper(epochs_concan_distr, fixedIndices_distr,...
            NaN_indices_EEG_distr, NaN_indices_EOG_distr, NaN_indices_moving_distr, NaN_indices_step_distr, reference_distr, vDiffOutMovWindow_distr, vDiffOutStep_distr, ...
        ...
        [epochs_concan_FASTER_std, artifactIndices_FASTER_std] = pre_artifactFASTER_wrapper(epochs_concan_std, fixedIndices_std,...
            NaN_indices_EEG_std, NaN_indices_EOG_std, NaN_indices_moving_std, NaN_indices_step_std, reference_std, vDiffOutMovWindow_std, vDiffOutStep_std, ...
