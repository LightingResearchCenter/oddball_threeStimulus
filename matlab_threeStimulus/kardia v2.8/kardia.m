...
%% ---- Export Data to Excel
    function excel_callback(src,evtdata)
        ...
        if ~isempty(datafile)
            ...
            % General Sheet
            xlswrite(datafile{1},SubjectsGeneral,'General','A1');
            xlswrite(datafile{1},eventfiles,'General','B1');
            xlswrite(datafile{1},allconditions,'General','C1');
            ...
            xlswrite(datafile{1},PCRparameterNames,'PCR','A1');
            xlswrite(datafile{1},PCRparameters,'PCR','B1');
            xlswrite(datafile{1},headerPCR,'PCR','E2');
            xlswrite(datafile{1},SubjectsPCR,'PCR','E1');
            xlswrite(datafile{1},varnamesPCR,'PCR','D1');
            xlswrite(datafile{1},datamatrixPCR,'PCR','E3');
            ...
            xlswrite(datafile{1},PCRparameterNames,'PCR Grand Average','A1');
            xlswrite(datafile{1},PCRparameters,'PCR Grand Average','B1');
            xlswrite(datafile{1},PCRconds,'PCR Grand Average','E1');
            xlswrite(datafile{1},bsl_values,'PCR Grand Average','E2');
            xlswrite(datafile{1},varnamesPCR(2:4,:),'PCR Grand Average','D1');
            xlswrite(datafile{1},hr_values,'PCR Grand Average','E3');
            ...
            xlswrite(datafile{1},HRVparameterNames,'HRV','A1');
            xlswrite(datafile{1},HRVparameters,'HRV','B1');
            xlswrite(datafile{1},HRV_VariableNames,'HRV','D1');
            xlswrite(datafile{1},SubjectsHRV,'HRV','E1');
            xlswrite(datafile{1},headerHRV,'HRV','E2');
            xlswrite(datafile{1},datamatrixHRV,'HRV','E3');            
            ...
            xlswrite(datafile{1},HRVparameterNames,'HRV Average','A1');
            xlswrite(datafile{1},HRVparameters,'HRV Average','B1');
            xlswrite(datafile{1},HRV_VariableNames(2:end,:),'HRV Average','D1');
            xlswrite(datafile{1},HRVconds,'HRV Average','E1');
            xlswrite(datafile{1},HRV_Variables,'HRV Average','E2');
        end
    end
...
%% PETTERI TEIKARI, modification

    % The subfunctions used to be here but it is easier to access them from
    % command-line if they are placed on the same folder on their own files
