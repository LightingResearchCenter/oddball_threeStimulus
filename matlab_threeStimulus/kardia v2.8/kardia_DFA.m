%% ---- DFA (default from Kardia)
function [alpha,n,Fn]=kardia_DFA(y,varargin)

    % Other options for DFA implementation, see for example:
    ...
    % Reference: Peng C-K, Havlin S, Stanley HE, Goldberger AL. 
