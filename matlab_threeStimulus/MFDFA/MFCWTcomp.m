function [s,q,Hq,h,Dh,logFq]=MFCWTcomp(signal,scmin,scmax,qmin,qmax,qres)
...
% [s,q,Hq1,h1,Dh1,logFq1]=MFCWTcomp(diff(VH1),10,200,0.1,3,30);
% [s,q,Hq2,h2,Dh2,logFq2]=MFCWTcomp(diff(VH2),10,200,0.1,3,30);
% figure;
% subplot(311)
...
[wt,period,scale]=wavelet(signal,1,1,1/16,scmin,J1,'morlet',6);
s=scale(scale<scmax);
logscale = log2(s);
detail = abs(wt.');
