...
function [h_loc,maxima_idx,h,h_row,h_pct,h_intr]=WTMM_local(signal,scmin,scmax,fig)
...
%[Coefs,scale]=contwtmir(signal,1/scmax,1/scmin,scres,0);
[Coefs,period,scale] = wavelet(signal,1,1,1/16,scmin,J1,'morlet',6);
Coefs=abs(Coefs);
