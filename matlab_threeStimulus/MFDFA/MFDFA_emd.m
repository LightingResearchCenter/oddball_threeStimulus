function [s,q,Hq,h,Dh,logFq]=MFDFA_emd(signal,qmin,qmax,qres)
%
% Multifractal detrended fluctuation analysis (MFDFA) with EMD based
% detrending
%
% [s,q,Hq,h,Dh,logFq]=MFDFA_emd(signal,qmin,qmax,qres);
%
% INPUT PARAMETERS-----------------------------------------------------
%
% signal:       input signal
...
% [s,q,Hq1,h1,Dh1,logFq1]=MFDFA_emd(diff(VH1),-3,3,31);
% [s,q,Hq2,h2,Dh2,logFq2]=MFDFA_emd(diff(VH2),-3,3,31);
% figure;
% subplot(311)
