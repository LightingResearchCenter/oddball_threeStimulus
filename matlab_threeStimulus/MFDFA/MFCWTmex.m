function [s,q,Hq,h,Dh,logFq]=MFCWTmex(signal,scmin,scmax,ressc,qmin,qmax,qres)
...
% [s,q,Hq1,h1,Dh1,logFq1]=MFCWTmex(diff(VH1),10,200,40,0.1,3,30);
% [s,q,Hq2,h2,Dh2,logFq2]=MFCWTmex(diff(VH2),10,200,40,0.1,3,30);
% figure;
% subplot(311)
...
[wt,scale]=contwtmir(signal,1/scmax,1/scmin,ressc,0);
%[wt,scale]=contwt(signal,1/scmax,1/scmin,ressc,0);
s=scale;
logscale = log2(scale(:));
detail = abs(wt.');
